...
export default function ConfiguracoesDRE() {
  ...
  const [showFdcToggle, setShowFdcToggle] = useState(dreConfig.incluirFDC || false);

  const totalFundoPeriodo = dreConfig.metaDiariaFundo * dreConfig.totalDiasMes;
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    switch (name) {
      case 'startDate':
        updateDREConfig({ startDate: value });
        break;
      case 'endDate':
            ...
            <section className="bg-blue-500/5 border border-blue-500/10 p-6 rounded-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl">
                  ...
                  <p className="text-[10px] text-slate-500 mt-2">{formatCurrency(despesasRestantes)} ÷ {dreConfig.totalDiasMes} dias</p>
                </div>
                ...
                <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl">
                  ...
                  <p className="text-[10px] text-slate-500 mt-2">{formatCurrency(dreConfig.metaDiariaFundo)} × {dreConfig.totalDiasMes} dias</p>
                </div>
              </div>
